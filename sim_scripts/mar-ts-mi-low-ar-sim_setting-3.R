...
saveRDS(x1, file = paste0(out_path, "/sim-results-mar-ts-mi-low-ar-", Sys.Date(), "-sim_setting-", 3, ".rds"))

x2 <- x1 |> 
    dplyr::bind_rows()
f_out <- paste0(out_path, "/sim-results-mar-ts-mi-low-ar-sim_setting-", 3, ".csv")
