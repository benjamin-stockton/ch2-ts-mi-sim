...
saveRDS(x1, file = paste0(out_path, "/sim-results-mar-ts-mi-arima-", Sys.Date(), "-sim_setting-", 9, ".rds"))

x2 <- x1 |> 
    dplyr::bind_rows()
f_out <- paste0(out_path, "/sim-results-mar-ts-mi-arima-sim_setting-", 9, ".csv")
